...
</custom-style>`;Cs.setAttribute("style","display: none;"),document.head.appendChild(Cs.content);var Ss=document.createElement("style");Ss.textContent="[hidden] { display: none !important; }",document.head.appendChild(Ss);const xs=cs`
<custom-style>
  <style is="custom-style">
    html {
...
`;xs.setAttribute("style","display: none;"),document.head.appendChild(xs.content);Bn({_template:cs`
    <style>
      :host {
        display: block;
        width: 200px;
